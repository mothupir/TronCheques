 ...
 */
export declare const enum FieldOptions_OptionRetention {
  RETENTION_UNKNOWN = 0,
  RETENTION_RUNTIME = 1,
  RETENTION_SOURCE = 2,
}
 ...
 */
export declare const enum FieldOptions_OptionTargetType {
 ...
 * .proto file.
 */
export declare const enum GeneratedCodeInfo_Annotation_Semantic {
